    ...
    async function fetchData() {
      try {
        ...
        const Data = await axios.get(
          `http://localhost:4000/data/${no}`          //route to fetch all company data related to name,location,description,ratings
        );
                ...
                return (
                  ...
                  <div className="card mb-3" style={{ marginLeft:"auto",marginRight:"auto",height:"40%"}}>
                      <div className="card-body" >
                          ...
                          <p className="card-text" style={{fontSize:"25px"}}>{item.description}</p>
